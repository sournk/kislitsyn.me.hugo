...
| # | Name | Type | Tags |
|---|------|------|------|
| 67 | **DWIB-MT5-Bot** <br> The "Don't Worry" trading strategy uses a consolidation beyond the Initial Balance session and structure breakdown to enter positions | `Private` | [`Trend`](/personal/algo/trend) [`PA/SMC`](/personal/algo/pasmc) |
